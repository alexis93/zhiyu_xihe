...
#define MATCH(s, n) strcmp(section, s) == 0 && strcmp(name, n) == 0
	...
	if (MATCH ("nmea_server","nmea_server_yn")){
		pconfig->nmea_server_yn = (uint16_t) atoi(value);
	} else if (MATCH ("nmea_server","nmea_server_name")){
		pconfig->nmea_server_name = strdup(value);
	} else if (MATCH ("nmea_server","nmea_server_address")){
	...
	} else if(MATCH ("gnss_server", "gnss_server_yn")) {
		pconfig->gnss_server_yn = (uint16_t) atoi(value);
	} else if(MATCH ("gnss_server", "gnss_server_name")) {
		pconfig->gnss_server_name = strdup(value);
	...
	} else if(MATCH ("gnss_nmea_server", "gnss_nmea_server_yn")) {
		pconfig->gnss_nmea_server_yn = (uint16_t) atoi(value);
	} else if(MATCH ("gnss_nmea_server", "gnss_nmea_server_name")) {
		pconfig->gnss_nmea_server_name = strdup(value);
	...
	} else if (MATCH("ins_server","ins_server_yn")){
		pconfig->ins_server_yn = (uint16_t) atoi(value);
	} else if (MATCH("ins_server","ins_server_name")){
		pconfig->ins_server_name = strdup(value);
	...
	} else if (MATCH("ins_nmea_server","ins_nmea_server_yn")){
		pconfig->ins_nmea_server_yn = (uint16_t)atoi(value);
	} else if (MATCH("ins_nmea_server","ins_nmea_server_name")){
		pconfig->ins_nmea_server_name = strdup(value);
