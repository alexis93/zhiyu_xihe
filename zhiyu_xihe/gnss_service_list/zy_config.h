...
struct gnss_config_s{
	uint16_t nmea_server_yn;
	char * nmea_server_name;
	char * nmea_server_address;
	uint16_t nmea_server_port;
	
	uint16_t gnss_server_yn;
	char * gnss_server_name;
	char * gnss_server_address;
	uint16_t gnss_server_port;
	
	uint16_t gnss_nmea_server_yn;
	char * gnss_nmea_server_name;
	char * gnss_nmea_server_address;
	uint16_t gnss_nmea_server_port;
	
	uint16_t ins_server_yn;
	char * ins_server_name;
	char * ins_server_address;
	uint16_t ins_server_port;
	
	uint16_t ins_nmea_server_yn;
	char * ins_nmea_server_name;
