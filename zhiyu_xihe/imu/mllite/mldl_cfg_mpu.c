...
int inv_mpu_get_slave_config(struct mldl_cfg *mldl_cfg,
                         ...
                         struct ext_slave_platform_data *pdata)
{
	MPL_LOGI("inv_mpu_get_slave_config");
    int result;
